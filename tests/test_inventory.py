...
from config.goods import (GOODS_EXPECTED_NAMES, GOODS_EXPECTED_PRICES,
                          ...
                          GOODS_SORT_ASC_EXPECTED_NAMES, ITEM_NAME)
...
class TestInventory:
    ...
    @allure.title("На странице товаров отображаются товары с определенными названиями")
    ...
    @allure.title("На странице товаров отображаются товары с определенными ценами")
    ...
    @allure.title("На странице товаров отображаются товары с валидными изображениями")
    ...
    @allure.title("При сортировке товаров по возрастанию цены товары располагаются от меньшей к большей цене")
    ...
    @allure.title("При сортировке товаров по убыванию цены товары располагаются от большей к меньшей цене")
    ...
    @allure.title("При сортировке товаров по имени товары сортируются по алфавиту")
    ...
    @allure.title("После добавления товара в корзину сортировка по убыванию цены работает корректно")
    ...
    @allure.title("При клике по изображению товара открывается подробная страница товара")
    ...
    @allure.title("После удаления товара через кнопку Remove на детальной странице корзина пуста")
